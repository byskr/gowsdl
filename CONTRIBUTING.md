...
* In Github, fork `https://github.com/byskr/gowsdl` to your own account
* Get the package using "go get": `go get github.com/byskr/gowsdl`
* Move to where the package was cloned: `cd $GOPATH/src/github.com/byskr/gowsdl/`
